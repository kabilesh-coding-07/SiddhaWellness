                                ...
                                <form onSubmit={handleSubmit} className="space-y-5">
                                    ...
                                    <div>
                                        ...
                                        <select className="form-input" value={form.subject} onChange={(e) => setForm({ ...form, subject: e.target.value })}>
                                            ...
                                            <option>{t('contact.topics.booking')}</option>
                                            <option>{t('contact.topics.treatment')}</option>
                                            <option>{t('contact.topics.feedback')}</option>
                                        </select>
                                    </div>
                                    <div>
                        ...
                        <div className="space-y-8">
                            <div className="glass-card p-8">
                                ...
                                <div className="space-y-4">
                                    {[
                                        { icon: '📍', label: t('contact.visitUs'), value: t('contact.addressValue') },
